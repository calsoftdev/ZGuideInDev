...
import com.calsoft.springbootjwthelloworld.model.JwtResponse;
...
public class JwtAuthenticationController {
	...
	private void authenticate(String username, String password) throws Exception {
		try {
			Authentication obj = 	authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(username, password));
